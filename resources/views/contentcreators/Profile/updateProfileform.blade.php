...
<html lang="en">
    <head>
        ...
        <title>Update Profile_form</title>
                    ...
                    <div class="row justify-content-center ">
                      <div class="col-lg-10">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            <div class="card-header"><h3 class="text-center font-weight-light my-4">Update Profile form</h3></div>
                            <div class="card-body">
                                @include('errors')
                                <form action="{{('/updateprofileform/'.$prof->content_id)}}" method="POST" enctype="multipart/form-data" id="formsubmit">
                                @csrf
