...
<html lang="en">
    <head>
        ...
        <title>View Tender | Creator</title>
                                    ...
                                    <div class="card-body">
                                        <table class="table">
                                            ...
                                            <tbody>
                                                {{-- @foreach ($order as $o) --}}
                                                <tr>
                                                    <th>Tender Id</th><td>{{$tender->tender_id}}</td>
                                                </tr>
                                                <tr>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <h6 class="fw-bold text-warning">Cant Edit right now</h6>
                                                            @else
                                                            <a class="btn btn-warning" href="/edittender/{{$id=$tender->tender_id}}">Edit</a>
                                                            @endif
                                                    </td>
                                                    <td>
                                                    </td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        @if($tender->status == 1)
                                                            <form action="{{('/sendtopubtender/'.$tender->tender_id)}}" method="POST" id="formSend">
                                                                {{ method_field('PUT') }}
                                                                {{ csrf_field() }}                    
                                                        ...
                                                        <form action="{{('/sendtopubtender/'.$tender->tender_id)}}" method="POST" id="formPending">
                                                            {{ method_field('PUT') }}
                                                            {{ csrf_field() }}                      
                                                            <button type="submit" class="btn  btn-outline-info" name="changeStatus" value="1" onclick="pending(event)">Pending</button>
                                                        </form>
                                                        @else
                                                        <form action="{{('/sendtopubtender/'.$tender->tender_id)}}" method="POST" id="formResend">
                                                            {{ method_field('PUT') }}
                                                            {{ csrf_field() }}                    
