                        ...
                        <div class="row justify-content-center">
                            <div class="col">
                                ...
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Acts</h3></div>
                                    <div class="card-body">
                                        <table class="table">
                                            <thead>
                                                <th>ID</th>
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    @if ($a->status == 0 || $a->status==3)
                                                        <td>{{$a->act_id}}</td>
                                                        <td>{{$a->title}}</td>
                                                        <td class="text-danger">{{$a->remark}}</td>
                                                        {{-- <td>{{$a->pdf}}</td> --}}
                                                        <td>
                                                            <a class="btn btn-info" href="viewactdetails/{{$id=$a->act_id}}">View</a>
                                                            <a class="btn btn-danger" href="deleteact/{{$id=$a->act_id}}" onclick="deleteConfirmation(event);">Delete</a>
                                                        </td>
