...
<html lang="en">
    <head>
        ...
        <title>Update | Map Category</title>
                    ...
                    <div class="row justify-content-center ">
                      <div class="col-lg-10">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                @include('errors')
                                <form action="{{('/updatemapcat/'.$map->content_id)}}" method="POST" enctype="multipart/form-data" id="formsubmit">
                                    @csrf
                                    <div class="form-floating mb-3">
                                        ...
                                        <h4>Availability of Form Details</h4>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="availability_name" id="flexRadioDefault1" onclick="showDownload(0);">
                                                <label class="form-check-label" for="flexRadioDefault1">
                                                Online Availability
                                                </label>
                                            </div>
                                            <div class="form-check">
                                                <input class="form-check-input" type="radio" name="availability_name" id="flexRadioDefault2" onclick="showDownload(1);">
