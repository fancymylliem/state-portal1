...
<html lang="en">
    <head>
        ...
        <title>Superadmin | Update Contact Data</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <div class="card-body">
                                <form action="{{('/updatetactdata/'.$contact->contact_id)}}" method="POST" id="formsubmit">
                                    @csrf
                                    <div class="row form-floating">
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="inputContactData" type="text" value="{{$contact->contact_name}}" name="contact_data" placeholder="" />
