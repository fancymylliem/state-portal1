...
<html lang="en">
    <head>
        ...
        <title>admin | Add Position Data</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <h3 class="text-center font-weight-light my-4">Add Position Data</h3>
                            ...
                            <div class="card-body">
                                <form action="{{('/newpositiondata')}}" method="POST">
                                    ...
                                    <div class="form-floating mb-3">
                                        <input class="form-control" id="inputPositionData" type="text" name="position_data" placeholder="position" />
