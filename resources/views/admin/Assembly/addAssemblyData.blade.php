...
<html lang="en">
    <head>
        ...
        <title>Superadmin | Add Assembly Data</title>
                ...
                <div class="row justify-content-center">
                    <div class="col-lg-5">
                        <div class="card shadow-lg border-0 rounded-lg mt-5">
                            ...
                            <h3 class="text-center font-weight-light my-4">Add Assembly Data</h3>
                            ...
                            <div class="card-body">
                                <form action="{{('/newassemblydata')}}" method="POST">
                                    ...
                                    <div class="d-flex align-items-center justify-content-between mt-4 mb-0">
                                        ...
                                        <a class="btn btn-outline-info" href="viewdocumenttype">View Assembly</a>
                                    </div>
                                </form>
                            </div> 
                        </div>
