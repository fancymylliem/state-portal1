                        ...
                        <div class="row justify-content-center">
                            <div class="col-lg-7">
                                <div class="card shadow-lg border-0 rounded-lg mt-5">
                                    <div class="card-header"><h3 class="text-center font-weight-light my-4">Add Department Admin/Publisher</h3></div>
                                    <div class="card-body">
                                        <form action="{{('/addnewdeptadmin')}}" method="POST">
                                            @csrf
                                                ...
                                                {{-- <div class="col-md-6"> --}}
                                                    <div class="form-floating mb-3 mb-md-0">
                                                        <select class="form-select" name="user_role" id="dept" aria-label="select Department">
                                                            ...
                                                            @elseif ($role->role=='draft')
                                                                <option value="{{$role->id}}">{{$role->role}}</option>

                                                            @elseif ($role->role=='Approver')
                                                                <option value="{{$role->id}}">{{$role->role}}</option>
                                                            @endif
                                                            @endforeach
                                                          </select>
